...
update_apotheke_request_instance = UpdateApothekeRequest.from_json(json)
# print the JSON string representation of the object
print(UpdateApothekeRequest.to_json())

# convert the object into a dict
update_apotheke_request_dict = update_apotheke_request_instance.to_dict()
# create an instance of UpdateApothekeRequest from a dict
update_apotheke_request_from_dict = UpdateApothekeRequest.from_dict(update_apotheke_request_dict)
```
